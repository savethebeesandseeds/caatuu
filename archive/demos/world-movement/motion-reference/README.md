...
The source was the Standard edition of the Quaternius Universal Animation
Library under CC0 1.0. Its canonical package now lives at
`apps/launcher/static/assets/motion/quaternius-standard-v1/`; this archived
viewer intentionally does not retain another copy.
...
This viewer is historical and is not exposed by the active runtime.
