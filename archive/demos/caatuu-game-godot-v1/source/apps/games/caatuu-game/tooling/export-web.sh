...
readonly work_root="/work/caatuu-game"
...
readonly -a required_notice_paths=(
    ...
    "LICENSES/Caatuu-Game-Style-Provenance.md"
...
readonly scenery_catalog_sha256="a45077c4291590e0d918bb72e1b6edf584505cd1be3bc4feaa488ce13e8ee531"
readonly scenery_layout_sha256="85915b86e4641aec8a2670045d19fe6db5009d996bc2750d1b738cae2efea71c"
...
test "$(realpath -m "${work_root}")" = "/work/caatuu-game"
...
cp \
    ...
    "${output_root}/LICENSES/Caatuu-Game-Style-Provenance.md"
cp \
...
printf 'Caatuu Game Web export completed with Godot '
