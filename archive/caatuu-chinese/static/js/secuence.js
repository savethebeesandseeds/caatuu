...
const PATH_BASE = location.pathname === '/archive/chinese' || location.pathname.startsWith('/archive/chinese/')
  ? '/archive/chinese'
  : (location.pathname === '/zh' || location.pathname.startsWith('/zh/') ? '/archive/chinese' : '');
const API_BASE = `${PATH_BASE}/api/v1`;
