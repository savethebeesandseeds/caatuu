...
$versionsFile = Join-Path $repoRoot "apps\android\tooling\versions.env"
...
$vendorDir = Join-Path $repoRoot "tools\on-device-models\vendor"
...
$patchFile = Join-Path $repoRoot "apps\android\patches\llama-android-thinking.patch"
