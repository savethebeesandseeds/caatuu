...
val caatuuVersionCode = providers.gradleProperty("caatuuVersionCode").map(String::toInt).orElse(155)
val caatuuVersionName = providers.gradleProperty("caatuuVersionName").orElse("0.1.4")
