...
val caatuuVersionCode = providers.gradleProperty("caatuuVersionCode").map(String::toInt).orElse(177)
val caatuuVersionName = providers.gradleProperty("caatuuVersionName").orElse("0.1.25")
