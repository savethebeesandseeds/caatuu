...
val caatuuVersionCode = providers.gradleProperty("caatuuVersionCode").map(String::toInt).orElse(153)
val caatuuVersionName = providers.gradleProperty("caatuuVersionName").orElse("0.1.3")
