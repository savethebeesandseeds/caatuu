...
val caatuuVersionCode = providers.gradleProperty("caatuuVersionCode").map(String::toInt).orElse(168)
val caatuuVersionName = providers.gradleProperty("caatuuVersionName").orElse("0.1.16")
