...
const validCatalog = {
  schema_version: 2,
  catalog_id: "caatuu-game-style-v1",
  catalog_version: 1,
  release_status: "local-preview-only",
  projection: {
    id: "caatuu-game-isometric",
    yaw_degrees: 45,
...
const validLayout = {
  ...
  catalog_id: "caatuu-game-style-v1",
  catalog_version: 1,
  projection_id: "caatuu-game-isometric",
  terrain: {
    columns: 3,
    rows: 2,
    cell_size: 0.5,
...
test("the real Memory Grove v6 reusable tiles, scales, collisions, hashes, and manifests remain mutually consistent", async () => {
  ...
  assert.ok(layoutExists, "Caatuu Game v3 catalog exists without its v6 layout");
  ...
  assert.equal(catalog.catalog_version, 3, "Caatuu Game scale calibration requires catalog version 3");
