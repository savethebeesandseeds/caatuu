...
import { normalizeWord, sentenceFingerprint } from "../../../../apps/language-runtime/static/source/word-net-core.mjs";
import { WordNetBranchQueue } from "../../../../apps/language-runtime/static/source/word-net-queue.mjs";

const wordNetSource = readFileSync(
  new URL("../../../../apps/language-runtime/static/source/product-word-world.mjs", import.meta.url),
  "utf8"
);
