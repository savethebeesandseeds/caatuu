...
test("the standalone shell loads shared state before its game controller", () => {
  ...
  const appStyle = page.indexOf('href="app.css?v=shell-73"');
  const chromeStyle = page.indexOf('href="chrome.css?v=chrome-style-91"');
  const cometStyle = page.indexOf('href="conjugation-comet.css?v=conjugation-comet-6"');
  const chrome = page.indexOf('src="chrome.js?v=chrome-92"');
...
test("browser setup and Android packaging share the exact reviewed logo", () => {
  ...
  assert.deepEqual(artifact, {
    ...
    bytes: 614649,
    sha256: "03d018fd7d5d128b59154220b3b899239c2987eab69f1a03eca2bb783855a8e0",
