...
function printHelp() {
  console.log(`Usage: node apps/runtime/tooling/refresh-setup-assets.mjs [options]
...
async function main() {
  ...
  const options = {
    ...
    languageStaticDir: resolve(workspaceRoot, args.languageStaticDir || "apps/languages/czech/static"),
