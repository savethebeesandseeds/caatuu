...
upstream source identity, retrieval date, modification history, and license
review are complete. Its centralized location prevents an active game from
depending on archived experiment code; it does not promote the package for
release.
