...
const speechPacesByDifficulty = Object.freeze({
  // Chromium converts Web Speech rates to integer Windows SAPI buckets.
  // These values stay distinct there while remaining useful on other engines.
  1: Object.freeze({ rate: 0.5, label: "slower" }),
  2: Object.freeze({ rate: 0.6, label: "slow" }),
