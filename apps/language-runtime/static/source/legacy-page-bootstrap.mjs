...
const CHROME_SCRIPT = "/language-runtime/static/source/caatuu-chrome.js?v=chrome-160";
const MAINTENANCE_SCRIPT = "/language-runtime/static/source/maintenance-ui.js?v=maintenance-23";
