...
const defaultLocalModelCatalog = {
  ...
  models: [
    ...
    },
    {
      ...
      short_label: "Word World",
      run_id: "cstinyllama-1.2b-planet-wordnet-003-clean-sft",
      repo_id: "BUT-FIT/CSTinyLlama-1.2B",
      license: "Apache-2.0",
      base_model: "BUT-FIT CSTinyLlama 1.2B",
      adapter: "cstinyllama-1.2b-planet-wordnet-003-clean-sft",
      intended_use: "Planet of Word World: generate one natural Czech sentence using the selected word or a natural Czech inflection of it.",
      status: "deprecated",
      deprecated: true,
    ...
    },
    {
      ...
      intended_use: "Given one Czech target word, generate one short ordinary Czech sentence for Planet of Word World.",
      status: "active",
      deprecated: false,
      replacement_status: "",
      supports_thinking: false,
