...
export const ENGLISH_AMERICAN_WORD_WORLD_PATHS = Object.freeze({
  ...
  learnerBaseRuntime: "apps/languages/english-from-spanish/static/data/games/word-world/starter-v1.es-base.json",
  ...
  realizationsRuntime: "apps/languages/english-from-spanish/static/data/games/word-world/starter-v1.realizations.json",
