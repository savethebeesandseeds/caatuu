...
RUN_ID="${RUN_ID:-cstinyllama-1.2b-czech-word-sentence-001}"
RUN_DIR="data/models/czech-finetuned/runs/$RUN_ID"
TRAIN_FILE="${TRAIN_FILE:-data/models/czech-finetuned/training-data/czech-word-sentence-001/train.jsonl}"
VAL_FILE="${VAL_FILE:-data/models/czech-finetuned/training-data/czech-word-sentence-001/val.jsonl}"
