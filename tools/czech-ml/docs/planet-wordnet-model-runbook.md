...
Add one entry to `tools/on-device-models/model-configs.json` using a new key:
...
"cstinyllama-1.2b-planet-wordnet-003-copy": {
  ...
  "license": "Apache-2.0",
  "model_hf_dir": "../czech-ml/data/models/czech-finetuned/exports/cstinyllama-1.2b-planet-wordnet-003-copy/merged-hf",
...
```text
apps/languages/czech/static/data/models/phone-bench/<model>.gguf
apps/languages/czech/static/data/models/phone-bench/<model>.gguf.sha256
apps/languages/czech/static/data/models/phone-bench/<model-key>.manifest.json
apps/languages/czech/static/data/models/phone-bench/models.json
```
...
apps/languages/czech/static/chat.js
apps/languages/czech/static/app.js
