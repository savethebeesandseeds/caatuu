...
Generated: 2026-08-13T19:18:03.107Z
...
- cc-000751 / cc-004608 | vector 0.9848 | token 1
...
- cc-003702 / cc-003919 | vector 0.9833 | token 0.6667
  - A sister wears a shoe.
  - A sister has a shoe.
  - Very close vector match; likely same learning example shape.
- cc-001641 / cc-004699 | vector 0.9806 | token 0.6667
  - A mother has a shoe.
  - A mother wears a shoe.
  - Very close vector match; likely same learning example shape.
- cc-002800 / cc-003431 | vector 0.9805 | token 0.6667
  - A girl has a hat.
  - A girl wears a hat.
  - Very close vector match; likely same learning example shape.
- cc-000659 / cc-004251 | vector 0.9795 | token 0.6667
  - The pear is green.
  - The pear is very green.
  - Very close vector match; likely same learning example shape.
- cc-000717 / cc-001244 | vector 0.9782 | token 0.75
  - A father has some soup.
  - A father likes some soup.
  - Very close vector match; likely same learning example shape.
- cc-002480 / cc-004227 | vector 0.9782 | token 0.6667
...
- cc-003682 / cc-004070 | vector 0.9772 | token 0.6667
  ...
  - Very close vector match; likely same learning example shape.
- cc-001871 / cc-004482 | vector 0.977 | token 0.6667
  - A grandpa wears a glove.
  - A grandpa has a glove.
  - Very close vector match; likely same learning example shape.
- cc-000040 / cc-003130 | vector 0.9769 | token 0.6667
  - A boy has a coat.
  - A boy wears a coat.
  - Very close vector match; likely same learning example shape.
...
- cc-003481 / cc-003692 | vector 0.9748 | token 0.6667
  ...
  - A mother has a hat.
  - Very close vector match; likely same learning example shape.
- cc-000161 / cc-004658 | vector 0.9747 | token 0.6667
  - A teacher wears a scarf.
  - A teacher has a scarf.
  - Very close vector match; likely same learning example shape.
- cc-002956 / cc-004344 | vector 0.974 | token 0.6667
  - A grandpa likes a paper.
  - A grandpa has a paper.
  - Very close vector match; likely same learning example shape.
- cc-000139 / cc-001160 | vector 0.9739 | token 0.6667
  - The egg is small.
  - The egg is very small.
  - Very close vector match; likely same learning example shape.
- cc-001227 / cc-003284 | vector 0.9727 | token 0.6667
  - A student has a rope.
  - A student needs a rope.
  - Very close vector match; likely same learning example shape.
- cc-001576 / cc-004482 | vector 0.9714 | token 0.6667
  - A grandpa needs a glove.
  - A grandpa has a glove.
  - Very close vector match; likely same learning example shape.
- cc-002409 / cc-003543 | vector 0.9714 | token 0.6
  - A brother needs some soup.
  - A brother wants some soup.
  - Very close vector match; likely same learning example shape.
- cc-001308 / cc-004895 | vector 0.97 | token 0.6667
  - The potato is hot.
...
- cc-002444 / cc-002600 | vector 0.97 | token 0.6667
  ...
  - Very close vector match; likely same learning example shape.
- cc-004272 / cc-004689 | vector 0.9687 | token 0.6667
...
- cc-001722 / cc-002538 | vector 0.9686 | token 0.6667
  ...
  - Very close vector match; likely same learning example shape.
- cc-001097 / cc-004508 | vector 0.9685 | token 0.6667
  - The sand is dry.
  - The sand is very dry.
  - Very close vector match; likely same learning example shape.
- cc-001130 / cc-003437 | vector 0.9685 | token 0.6667
