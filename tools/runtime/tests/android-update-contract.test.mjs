...
const [manager, bridge, filePaths, maintenanceUi, setup] = await Promise.all([
  readFile(new URL(
    "../../../apps/caatuu-android/app/src/main/java/com/caatuu/android/AppUpdateManager.kt",
    import.meta.url
  ), "utf8"),
  readFile(new URL(
    "../../../apps/caatuu-android/app/src/main/java/com/caatuu/android/CaatuuBridge.kt",
    import.meta.url
  ), "utf8"),
  readFile(new URL(
    "../../../apps/caatuu-android/app/src/main/res/xml/caatuu_file_paths.xml",
    import.meta.url
  ), "utf8"),
  readFile(new URL("../../../apps/caatuu-czech/static/maintenance-ui.js", import.meta.url), "utf8"),
  readFile(new URL("../../../apps/caatuu-czech/static/setup.js", import.meta.url), "utf8")
]);
