...
import { normalizeWord, sentenceFingerprint } from "../../../apps/caatuu-czech/static/word-net-core.mjs";
import { WordNetBranchQueue } from "../../../apps/caatuu-czech/static/word-net-queue.mjs";
