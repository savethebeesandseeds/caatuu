...
const [
  ...
  read("apps/caatuu-unified/static/index.html"),
  read("apps/caatuu-unified/static/launcher.js"),
  read("apps/caatuu-unified/static/languages.json"),
  read("apps/caatuu-czech/static/chrome.js"),
  read("apps/caatuu-czech/static/app.js"),
  read("apps/caatuu-czech/static/chat.js"),
  read("apps/caatuu-czech/static/chat.html"),
  read("apps/caatuu-runtime/src/routes/mod.rs"),
  read("apps/caatuu-czech/static/data/models/phone-bench/models.json")
]);
