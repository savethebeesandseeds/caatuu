...
| FP-007 | Machine-assisted Spanish and Spanish-to-English development curriculum | Catalog metadata records `release-review-required`; Android product APK 170 includes these development courses, while Pages enablement remains separate | `REVIEW` | Confirm authorship and exact license scope, record approval in the formal content gate, then review public platform enablement separately; Android inclusion is not content clearance |
| FP-008 | Original AI-assisted Norwegian Bokmål development curriculum | The [onboarding review receipt](../apps/languages/norwegian-bokmal/content/reviews/onboarding-20260909.json) records source hashes and grammatical-fact references; dictionary definitions and examples were not imported | `REVIEW` | Record the owner's exact curriculum license decision before Android or Pages distribution; native-speaker review remains a separate activation gate |
