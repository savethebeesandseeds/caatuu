...
| FP-007 | Machine-assisted Spanish Word World and Verb Nebula development curriculum | Catalog metadata records `release-review-required`; it is excluded from current Pages and Android delivery | `NOT-DISTRIBUTED` / `REVIEW` | Confirm authorship and exact license scope, record approval in the formal content gate, then review public platform enablement separately |
